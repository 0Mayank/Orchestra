...
type PaymentServiceClient interface {
	...
	ListPayments(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PaymentList, error)
	DeletePayment(ctx context.Context, in *PaymentId, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *paymentServiceClient) ListPayments(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PaymentList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentList)
...
func (c *paymentServiceClient) DeletePayment(ctx context.Context, in *PaymentId, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
type PaymentServiceServer interface {
	...
	ListPayments(context.Context, *Empty) (*PaymentList, error)
	DeletePayment(context.Context, *PaymentId) (*Empty, error)
...
func (UnimplementedPaymentServiceServer) ListPayments(context.Context, *Empty) (*PaymentList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ListPayments not implemented")
}
func (UnimplementedPaymentServiceServer) DeletePayment(context.Context, *PaymentId) (*Empty, error) {
...
func _PaymentService_ListPayments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).ListPayments(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto_def/payment.proto",
}
